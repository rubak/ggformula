...
a variable in `data` and setting will be used otehrwise.  The other two forms 
can be used when this auto-detection method doesn't yield the desired results
