...
going to the next page, see if you can figure out what they are.
...
To make this plot, the answers to our questiosn are 

  1. Make a scatter plot (i.e., a **plot** consisting of **points**)
  
  2. The data used for the plot:
      a. The variable to be plotted along the $y$ axis.
      b. The variable to be plotted along the $x$ axis.
      c. The data set that contain the variables.
...
Most `gf_` functions take a formala that describes the positional
...
Time to explore on your own.  Here are three data sets you can use.
  ...
  * `KidsFeet` has information about some kids's feet.
 ...
 * You can put more than one plot a code chunk, but we've provided two chunks
...
things like:
  ...
  * labeling, including titles an axis labels
 ...
 * **frame** -- the bounding rectagle in which the plot is constructed.  This 
